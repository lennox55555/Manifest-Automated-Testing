...
const filter = require('./filter-282048a2.js');
...
function XButton({ disabled, key, label, onClick, ref, scale, }) {
  return (index.h("button", { "aria-label": label, class: CSS$2.button, disabled: disabled, key: key, onClick: onClick, tabIndex: -1, type: "button", 
    // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
    ref: ref },
    index.h("calcite-icon", { icon: "x", scale: scale === "l" ? "m" : "s" })));
}
