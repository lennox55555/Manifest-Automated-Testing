...
const CalciteNavigation = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: {
      ...
      } }, index.h("div", { class: { [CSS$2.hide]: !this.progressSlotHasElement, [SLOTS.progress]: true } }, index.h("slot", { name: SLOTS.progress, onSlotchange: this.handleProgressSlotChange })), index.h("div", { class: { [CSS$2.containerContent]: true, [CSS$2.hasProgress]: this.progressSlotHasElement } }, this.renderMenuAction(), index.h("div", { class: { [CSS$2.hide]: !this.logoSlotHasElements, [SLOTS.logo]: true } }, index.h("slot", { name: SLOTS.logo, onSlotchange: this.handleLogoSlotChange })), index.h("slot", { name: SLOTS.contentStart, onSlotchange: this.handleContentStartSlotChange }), index.h("slot", { name: SLOTS.contentCenter, onSlotchange: this.handleContentCenterSlotChange }), index.h("slot", { name: SLOTS.contentEnd, onSlotchange: this.handleContentEndSlotChange }), index.h("div", { class: { [CSS$2.hide]: !this.userSlotHasElements, [SLOTS.user]: true } }, index.h("slot", { name: SLOTS.user, onSlotchange: this.handleUserSlotChange })))), index.h(index.Fragment, null, index.h("slot", { name: SLOTS.navSecondary, onSlotchange: this.handleSecondarySlotChange }), index.h("slot", { name: SLOTS.navTertiary, onSlotchange: this.handleTertiarySlotChange }))));
  }
...
const CalciteNavigationLogo = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("a", { class: CSS$1.anchor, href: this.href, rel: this.rel, target: this.target }, thumbnail && index.h("img", { alt: this.label || "", class: CSS$1.image, src: thumbnail }), (heading || description) && (index.h("div", { class: CSS$1.container }, heading && (index.h("span", { "aria-label": this.heading, class: {
        [CSS$1.heading]: true,
        [CSS$1.standalone]: !this.description,
      }, key: CSS$1.heading }, heading)), description && (index.h("span", { "aria-label": this.description, class: CSS$1.description, key: CSS$1.description }, description)))))));
  }
