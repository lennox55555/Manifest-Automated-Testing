...
const resources = require('./resources-09dc3cc2.js');
...
const Panel = class {
  ...
  renderHeaderActionsEnd() {
    ...
    const closableNode = closable ? (index.h("calcite-action", { "aria-label": text, "data-test": "close", icon: resources.ICONS.close, onClick: close, text: text, title: text,
    ...
    return (index.h("div", { class: { [resources.CSS.headerActionsEnd]: true, [resources.CSS.headerActions]: true }, hidden: !showContainer, key: "header-actions-end" }, slotNode, this.renderMenu(), closableNode));
  }
  renderMenu() {
  ...
  renderContent() {
    return (index.h("div", { class: resources.CSS.contentWrapper, onScroll: this.panelScrollHandler,
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
