...
const TextArea = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("textarea", { "aria-describedby": this.guid, "aria-invalid": dom.toAriaBoolean(this.isCharacterLimitExceeded()), "aria-label": label.getLabelText(this), autofocus: this.autofocus, class: {
