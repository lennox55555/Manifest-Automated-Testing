...
const form = require('./form-27befe54.js');
const guid = require('./guid-a8269edb.js');
const interactive = require('./interactive-3bb6deb3.js');
const key = require('./key-a0314f25.js');
const label = require('./label-dc984ee1.js');
const loadable = require('./loadable-9f17151a.js');
const locale$1 = require('./locale-29f97b64.js');
const focusTrapComponent = require('./focusTrapComponent-917ed18b.js');
const math = require('./math-a50a7a62.js');
...
function getLocalizedDecimalSeparator(locale, numberingSystem) {
  ...
  return locale$1.numberStringFormatter.localize("1.1").split("")[1];
}
...
function localizeTimePart({ value, part, locale, numberingSystem }) {
  if (part === "fractionalSecond") {
    ...
    if (value) {
      ...
      const localizedZero = locale$1.numberStringFormatter.localize("0");
      if (parseInt(value) === 0) {
        localizedFractionalSecond = "".padStart(value.length, localizedZero);
      }
      else {
        localizedFractionalSecond = locale$1.numberStringFormatter
          .localize(`0.${value}`)
...
const supportedDayjsLocaleToLocaleConfigImport = new Map([
  ["ar", () => Promise.resolve().then(function () { return require('./ar-3a665b78.js'); })],
  ["bg", () => Promise.resolve().then(function () { return require('./bg-4d72ea85.js'); })],
  ["bs", () => Promise.resolve().then(function () { return require('./bs-55afe249.js'); })],
  ["ca", () => Promise.resolve().then(function () { return require('./ca-82563203.js'); })],
  ["cs", () => Promise.resolve().then(function () { return require('./cs-bfc3400c.js'); })],
  ["da", () => Promise.resolve().then(function () { return require('./da-25a0bf95.js'); })],
  ["de", () => Promise.resolve().then(function () { return require('./de-2fbc6c3e.js'); })],
  ["de-at", () => Promise.resolve().then(function () { return require('./de-at-d379ded3.js'); })],
  ["de-ch", () => Promise.resolve().then(function () { return require('./de-ch-13fbb739.js'); })],
  ["el", () => Promise.resolve().then(function () { return require('./el-b1651f08.js'); })],
  ["en", () => Promise.resolve().then(function () { return en$1; })],
  ["en-au", () => Promise.resolve().then(function () { return require('./en-au-41c17a82.js'); })],
  ["en-ca", () => Promise.resolve().then(function () { return require('./en-ca-7a2601b1.js'); })],
  ["en-gb", () => Promise.resolve().then(function () { return require('./en-gb-b4107d27.js'); })],
  ["es", () => Promise.resolve().then(function () { return require('./es-4950cf55.js'); })],
  ["es-mx", () => Promise.resolve().then(function () { return require('./es-mx-8f93bdb3.js'); })],
  ["et", () => Promise.resolve().then(function () { return require('./et-ec13f04e.js'); })],
  ["fi", () => Promise.resolve().then(function () { return require('./fi-d6376427.js'); })],
  ["fr", () => Promise.resolve().then(function () { return require('./fr-c69faf02.js'); })],
  ["fr-ch", () => Promise.resolve().then(function () { return require('./fr-ch-aed23cbd.js'); })],
  ["he", () => Promise.resolve().then(function () { return require('./he-67f42317.js'); })],
  ["hi", () => Promise.resolve().then(function () { return require('./hi-04a0147a.js'); })],
  ["hr", () => Promise.resolve().then(function () { return require('./hr-34524375.js'); })],
  ["hu", () => Promise.resolve().then(function () { return require('./hu-1f356af6.js'); })],
  ["id", () => Promise.resolve().then(function () { return require('./id-6d7a1a09.js'); })],
  ["it", () => Promise.resolve().then(function () { return require('./it-43b612b9.js'); })],
  ["it-ch", () => Promise.resolve().then(function () { return require('./it-ch-9e75c317.js'); })],
  ["ja", () => Promise.resolve().then(function () { return require('./ja-cb86ad6a.js'); })],
  ["ko", () => Promise.resolve().then(function () { return require('./ko-85b6231c.js'); })],
  ["lt", () => Promise.resolve().then(function () { return require('./lt-23c2c1ef.js'); })],
  ["lv", () => Promise.resolve().then(function () { return require('./lv-2d9c4b08.js'); })],
  ["mk", () => Promise.resolve().then(function () { return require('./mk-df9a2de6.js'); })],
  ["nl", () => Promise.resolve().then(function () { return require('./nl-653f0c7f.js'); })],
  ["nb", () => Promise.resolve().then(function () { return require('./nb-b318ebff.js'); })],
  ["pl", () => Promise.resolve().then(function () { return require('./pl-f1a90c9d.js'); })],
  ["pt", () => Promise.resolve().then(function () { return require('./pt-257cbe1c.js'); })],
  ["pt-br", () => Promise.resolve().then(function () { return require('./pt-br-f38824aa.js'); })],
  ["ro", () => Promise.resolve().then(function () { return require('./ro-fda66644.js'); })],
  ["ru", () => Promise.resolve().then(function () { return require('./ru-e1e1363c.js'); })],
  ["sk", () => Promise.resolve().then(function () { return require('./sk-fa5539c9.js'); })],
  ["sl", () => Promise.resolve().then(function () { return require('./sl-b0e1baba.js'); })],
  ["sr", () => Promise.resolve().then(function () { return require('./sr-1165d336.js'); })],
  ["sv", () => Promise.resolve().then(function () { return require('./sv-89f8f9f2.js'); })],
  ["th", () => Promise.resolve().then(function () { return require('./th-c1ef9518.js'); })],
  ["tr", () => Promise.resolve().then(function () { return require('./tr-f438d5b0.js'); })],
  ["uk", () => Promise.resolve().then(function () { return require('./uk-c79f6aea.js'); })],
  ["vi", () => Promise.resolve().then(function () { return require('./vi-d0366090.js'); })],
  ["zh-cn", () => Promise.resolve().then(function () { return require('./zh-cn-837c9fc7.js'); })],
  ["zh-hk", () => Promise.resolve().then(function () { return require('./zh-hk-9d974d62.js'); })],
  ["zh-tw", () => Promise.resolve().then(function () { return require('./zh-tw-048613a3.js'); })],
]);
...
const TimePicker = class {
  constructor(hostRef) {
    ...
    this.decrementFractionalSecond = () => {
  ...
  render() {
    ...
    const fractionalSecondIsNumber = locale$1.isValidNumber(this.fractionalSecond);
    ...
    return (index.h("div", { class: {
      ...
      }, onClick: this.incrementHour, role: "button" }, index.h("calcite-icon", { icon: "chevron-up", scale: iconScale })), index.h("span", { "aria-label": this.messages.hour, "aria-valuemax": "23", "aria-valuemin": "1", "aria-valuenow": (hourIsNumber && parseInt(this.hour)) || "0", "aria-valuetext": this.hour, class: {
        [CSS.input]: true,
        [CSS.hour]: true,
      ...
      }, onClick: this.decrementHour, role: "button" }, index.h("calcite-icon", { icon: "chevron-down", scale: iconScale }))), index.h("span", { class: CSS.delimiter }, this.localizedHourSuffix), index.h("div", { class: CSS.column, role: "group" }, index.h("span", { "aria-label": this.messages.minuteUp, class: {
        [CSS.button]: true,
        [CSS.buttonMinuteUp]: true,
      }, onClick: this.incrementMinute, role: "button" }, index.h("calcite-icon", { icon: "chevron-up", scale: iconScale })), index.h("span", { "aria-label": this.messages.minute, "aria-valuemax": "12", "aria-valuemin": "1", "aria-valuenow": (minuteIsNumber && parseInt(this.minute)) || "0", "aria-valuetext": this.minute, class: {
        [CSS.input]: true,
        [CSS.minute]: true,
      ...
      }, onClick: this.decrementMinute, role: "button" }, index.h("calcite-icon", { icon: "chevron-down", scale: iconScale }))), this.showSecond && index.h("span", { class: CSS.delimiter }, this.localizedMinuteSuffix), this.showSecond && (index.h("div", { class: CSS.column, role: "group" }, index.h("span", { "aria-label": this.messages.secondUp, class: {
        [CSS.button]: true,
        [CSS.buttonSecondUp]: true,
      }, onClick: this.incrementSecond, role: "button" }, index.h("calcite-icon", { icon: "chevron-up", scale: iconScale })), index.h("span", { "aria-label": this.messages.second, "aria-valuemax": "59", "aria-valuemin": "0", "aria-valuenow": (secondIsNumber && parseInt(this.second)) || "0", "aria-valuetext": this.second, class: {
        [CSS.input]: true,
        [CSS.second]: true,
      ...
      }, onClick: this.decrementSecond, role: "button" }, index.h("calcite-icon", { icon: "chevron-down", scale: iconScale })))), this.showFractionalSecond && (index.h("span", { class: CSS.delimiter }, this.localizedDecimalSeparator)), this.showFractionalSecond && (index.h("div", { class: CSS.column, role: "group" }, index.h("span", { "aria-label": this.messages.fractionalSecondUp, class: {
        [CSS.button]: true,
        [CSS.buttonFractionalSecondUp]: true,
      }, onClick: this.incrementFractionalSecond, role: "button" }, index.h("calcite-icon", { icon: "chevron-up", scale: iconScale })), index.h("span", { "aria-label": this.messages.fractionalSecond, "aria-valuemax": "999", "aria-valuemin": "1", "aria-valuenow": (fractionalSecondIsNumber && parseInt(this.fractionalSecond)) || "0", "aria-valuetext": this.localizedFractionalSecond, class: {
        [CSS.input]: true,
        [CSS.fractionalSecond]: true,
      }, onFocus: this.focusHandler, onKeyDown: this.fractionalSecondKeyDownHandler, role: "spinbutton", tabIndex: 0,
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
      ref: this.setFractionalSecondEl }, this.localizedFractionalSecond || "--"), index.h("span", { "aria-label": this.messages.fractionalSecondDown, class: {
        [CSS.button]: true,
        [CSS.buttonFractionalSecondDown]: true,
      }, onClick: this.decrementFractionalSecond, role: "button" }, index.h("calcite-icon", { icon: "chevron-down", scale: iconScale })))), this.localizedSecondSuffix && (index.h("span", { class: CSS.delimiter }, this.localizedSecondSuffix)), showMeridiem && (index.h("div", { class: {
        [CSS.column]: true,
      ...
      }, onClick: this.incrementMeridiem, role: "button" }, index.h("calcite-icon", { icon: "chevron-up", scale: iconScale })), index.h("span", { "aria-label": this.messages.meridiem, "aria-valuemax": "2", "aria-valuemin": "1", "aria-valuenow": (this.meridiem === "PM" && "2") || "1", "aria-valuetext": this.meridiem, class: {
        [CSS.input]: true,
        [CSS.meridiem]: true,
      ...
      }, onClick: this.decrementMeridiem, role: "button" }, index.h("calcite-icon", { icon: "chevron-down", scale: iconScale }))))));
  }
  static get delegatesFocus() { return true; }
  static get assetsDirs() { return ["assets"]; }
  get el() { return index.getElement(this); }
