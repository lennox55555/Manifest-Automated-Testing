...
const Shell = class {
  ...
  // --------------------------------------------------------------------------
  renderHeader() {
    return (index.h("div", { hidden: !this.hasHeader }, index.h("slot", { key: "header", name: SLOTS$2.header, onSlotchange: this.handleHeaderSlotChange })));
  }
  renderFooter() {
    return (index.h("div", { class: CSS$2.footer, hidden: !this.hasFooter, key: "footer" }, index.h("slot", { name: SLOTS$2.footer, onSlotchange: this.handleFooterSlotChange })));
  }
  renderAlerts() {
    return (index.h("div", { hidden: !this.hasAlerts }, index.h("slot", { key: "alerts", name: SLOTS$2.alerts, onSlotchange: this.handleAlertsSlotChange })));
  }
  renderSheets() {
    return (index.h("div", { hidden: !this.hasSheets }, index.h("slot", { key: "sheets", name: SLOTS$2.sheets, onSlotchange: this.handleSheetsSlotChange })));
  }
  renderModals() {
    return (index.h("div", { hidden: !this.hasModals }, index.h("slot", { key: "modals", name: SLOTS$2.modals, onSlotchange: this.handleModalsSlotChange })));
  }
  renderContent() {
    const defaultSlotNode = index.h("slot", { key: "default-slot" });
    const deprecatedCenterRowSlotNode = (index.h("slot", { key: "center-row-slot", name: SLOTS$2.centerRow }));
    const panelBottomSlotNode = index.h("slot", { key: "panel-bottom-slot", name: SLOTS$2.panelBottom });
    const panelTopSlotNode = index.h("slot", { key: "panel-top-slot", name: SLOTS$2.panelTop });
    ...
    const content = !!this.contentBehind
      ? [
        ...
        index.h("div", { class: CSS$2.contentBehindCenterContent }, panelTopSlotNode, panelBottomSlotNode, deprecatedCenterRowSlotNode),
      ]
      : [
        index.h("div", { class: CSS$2.content, key: contentContainerKey }, panelTopSlotNode, defaultSlotNode, panelBottomSlotNode, deprecatedCenterRowSlotNode),
      ];
    return content;
  }
  renderMain() {
    return (index.h("div", { class: CSS$2.main }, index.h("slot", { name: SLOTS$2.panelStart }), this.renderContent(), index.h("slot", { name: SLOTS$2.panelEnd })));
  }
  renderPositionedSlots() {
    return (index.h("div", { class: CSS$2.positionedSlotWrapper }, this.renderAlerts(), this.renderModals(), this.renderSheets()));
  }
  render() {
...
const ShellPanel = class {
  ...
  // --------------------------------------------------------------------------
  renderHeader() {
    return (index.h("div", { class: CSS.contentHeader, hidden: !this.hasHeader, key: "header" }, index.h("slot", { name: SLOTS.header, onSlotchange: this.handleHeaderSlotChange })));
  }
  render() {
    ...
    const contentNode = (index.h("div", { class: {
      ...
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
      ref: this.storeContentEl }, this.renderHeader(), index.h("div", { class: CSS.contentBody }, index.h("slot", null)), separatorNode));
    const actionBarNode = (index.h("slot", { key: "action-bar", name: SLOTS.actionBar, onSlotchange: this.handleActionBarSlotChange }));
