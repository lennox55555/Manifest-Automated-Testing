...
const TableCell = class {
  ...
  //--------------------------------------------------------------------------
  render() {
    return (index.h(index.Host, null, index.h("td", { "aria-disabled": this.disabled, class: {
