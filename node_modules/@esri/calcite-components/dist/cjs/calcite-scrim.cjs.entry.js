...
const Scrim = class {
  ...
  render() {
    ...
    return (index.h("div", { class: CSS.scrim }, loading ? (index.h("calcite-loader", { label: messages.loading, ref: this.storeLoaderEl, scale: this.loaderScale })) : null, index.h("div", { class: CSS.content, hidden: !hasContent }, index.h("slot", { onSlotchange: this.handleDefaultSlotChange }))));
  }
  getScale(size) {
