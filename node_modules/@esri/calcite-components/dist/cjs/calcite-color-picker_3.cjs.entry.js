...
const utils = require('./utils-2ac002c4.js');
...
const throttle = require('./throttle-7a457cee.js');
...
const ColorPicker = class {
  constructor(hostRef) {
    ...
    this.renderChannel = (value, index$1, ariaLabel, direction, suffix) => {
      return (index.h("calcite-input-number", { class: CSS$2.channel, "data-channel-index": index$1, dir: direction, key: index$1, label: ariaLabel, lang: this.effectiveLocale, numberButtonType: "none", numberingSystem: this.numberingSystem, onCalciteInputNumberChange: this.handleChannelChange, onCalciteInputNumberInput: this.handleChannelInput, onKeyDown: this.handleKeyDown, scale: this.scale === "l" ? "m" : "s",
  ...
  render() {
    ...
    const opacityLeft = opacityScopeLeft ??
      (sliderWidth * utils.alphaToOpacity(DEFAULT_COLOR$1.alpha())) / OPACITY_LIMITS.max;
    ...
    return (index.h("div", { class: CSS$2.container }, index.h("div", { class: CSS$2.controlAndScope }, index.h("canvas", { class: CSS$2.colorField, onPointerDown: this.handleColorFieldPointerDown,
      ...
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
      ref: this.initHueSlider }), index.h("div", { "aria-label": messages.hue, "aria-valuemax": HSV_LIMITS.h, "aria-valuemin": "0", "aria-valuenow": color?.round().hue() || DEFAULT_COLOR$1.round().hue(), class: { [CSS$2.scope]: true, [CSS$2.hueScope]: true }, onKeyDown: this.handleHueScopeKeyDown, role: "slider", style: {
      ...
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
      ref: this.initOpacitySlider }), index.h("div", { "aria-label": messages.opacity, "aria-valuemax": OPACITY_LIMITS.max, "aria-valuemin": OPACITY_LIMITS.min, "aria-valuenow": (color || DEFAULT_COLOR$1).round().alpha(), class: { [CSS$2.scope]: true, [CSS$2.opacityScope]: true }, onKeyDown: this.handleOpacityScopeKeyDown, role: "slider", style: {
...
const ColorPickerHexInput = class {
  ...
  render() {
    ...
    return (index.h("div", { class: CSS$1.container }, index.h("calcite-input-text", { class: CSS$1.hexInput, label: messages?.hex || hexLabel, maxLength: 6, onCalciteInputTextChange: this.onHexInputChange, onCalciteInternalInputTextBlur: this.onHexInputBlur, onKeyDown: this.onInputKeyDown, onPaste: this.onHexInputPaste, prefixText: "#", scale: inputScale, value: hexInputValue,
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
