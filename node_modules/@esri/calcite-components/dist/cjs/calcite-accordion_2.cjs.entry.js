  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: {
        ...
        : this.iconType === "caret"
          ...
          : this.expanded
            ? "minus"
            : "plus", scale: this.scale === "l" ? "m" : "s" })), this.renderActionsEnd()), index.h("section", { "aria-labelledby": IDS.sectionToggle, class: CSS.content, id: IDS.section }, index.h("slot", null)))));
  }
  //--------------------------------------------------------------------------
  //
  //  Event Listeners
