...
const Button = class {
  ...
  render() {
    ...
    const loaderNode = this.hasLoader ? (index.h("div", { class: CSS.buttonLoader }, index.h("calcite-loader", { class: this.loading ? CSS.loadingIn : CSS.loadingOut, inline: true, label: this.messages.loading, scale: this.scale === "l" ? "m" : "s" }))) : null;
    ...
    const contentEl = (index.h("span", { class: CSS.content, ref: (el) => (this.contentEl = el) }, index.h("slot", null)));
    return (index.h(Tag, { "aria-label": !this.loading ? label.getLabelText(this) : this.messages.loading, "aria-live": "polite", class: {
