 ...
 * v1.7.0
 */
import { proxyCustomElement, HTMLElement, createEvent, h, Fragment, Host } from '@stencil/core/internal/client/index.js';
import { s as slotChangeGetAssignedElements, C as CSS_UTILITY, b as getElementDir } from './dom.js';
...
const CalciteMenuItem$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
export { CalciteMenuItem, defineCustomElement };
