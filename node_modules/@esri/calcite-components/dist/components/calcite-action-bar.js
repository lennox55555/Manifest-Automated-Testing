...
import { s as slotChangeGetAssignedElements, e as slotChangeHasAssignedElement, f as focusFirstTabbable } from './dom.js';
...
const ActionBar = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  ...
  renderBottomActionGroup() {
    ...
    return (h("calcite-action-group", { class: CSS.actionGroupEnd, label: actionsEndGroupLabel, hidden: this.expandDisabled && !(this.hasActionsEnd || this.hasBottomActions), layout: layout, scale: scale }, h("slot", { name: SLOTS.actionsEnd, onSlotchange: this.handleActionsEndSlotChange }), h("slot", { name: SLOTS.bottomActions, onSlotchange: this.handleBottomActionsSlotChange }), h("slot", { name: SLOTS.expandTooltip, onSlotchange: this.handleTooltipSlotChange }), expandToggleNode));
  }
  render() {
