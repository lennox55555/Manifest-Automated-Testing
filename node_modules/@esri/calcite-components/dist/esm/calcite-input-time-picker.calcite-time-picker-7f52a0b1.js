...
import { s as submitForm, c as connectForm, d as disconnectForm, H as HiddenFormInputSlot } from './form-c73d3da5.js';
import { g as guid } from './guid-3f32a87e.js';
import { c as connectInteractive, d as disconnectInteractive, u as updateHostInteraction } from './interactive-5801a6e6.js';
import { n as numberKeys } from './key-120fe23c.js';
import { c as connectLabel, d as disconnectLabel, g as getLabelText } from './label-b88198aa.js';
import { c as componentFocusable, s as setUpLoadableComponent, a as setComponentLoaded } from './loadable-d814078e.js';
import { n as numberStringFormatter, b as getDateTimeFormat, i as isValidNumber, e as getSupportedNumberingSystem, g as getSupportedLocale, c as connectLocalized, d as disconnectLocalized } from './locale-b09d220a.js';
import { d as deactivateFocusTrap, a as activateFocusTrap, c as connectFocusTrap } from './focusTrapComponent-0e7ce2bc.js';
import { d as decimalPlaces, g as getDecimals } from './math-4e0ea91f.js';
import { c as connectMessages, s as setUpMessages, d as disconnectMessages, u as updateMessages } from './t9n-9a6203a1.js';
...
const supportedDayjsLocaleToLocaleConfigImport = new Map([
  ["ar", () => import('./ar-2e277070.js')],
  ["bg", () => import('./bg-e07a9213.js')],
  ["bs", () => import('./bs-41a2ac4e.js')],
  ["ca", () => import('./ca-9028fb84.js')],
  ["cs", () => import('./cs-65ce1c2c.js')],
  ["da", () => import('./da-2a5cdb6d.js')],
  ["de", () => import('./de-63dab6b5.js')],
  ["de-at", () => import('./de-at-cefb939e.js')],
  ["de-ch", () => import('./de-ch-9ea5f1c8.js')],
  ["el", () => import('./el-c21e163a.js')],
  ["en", () => Promise.resolve().then(function () { return en$1; })],
  ["en-au", () => import('./en-au-f8ec7bc2.js')],
  ["en-ca", () => import('./en-ca-c85ea8e4.js')],
  ["en-gb", () => import('./en-gb-78865153.js')],
  ["es", () => import('./es-3cb6d7cc.js')],
  ["es-mx", () => import('./es-mx-7809a516.js')],
  ["et", () => import('./et-d171eed3.js')],
  ["fi", () => import('./fi-31096c23.js')],
  ["fr", () => import('./fr-1bccea25.js')],
  ["fr-ch", () => import('./fr-ch-875d946f.js')],
  ["he", () => import('./he-847d52e7.js')],
  ["hi", () => import('./hi-88458672.js')],
  ["hr", () => import('./hr-fd6b5c9b.js')],
  ["hu", () => import('./hu-64bd3986.js')],
  ["id", () => import('./id-4f1b7225.js')],
  ["it", () => import('./it-62b2a421.js')],
  ["it-ch", () => import('./it-ch-7c189f43.js')],
  ["ja", () => import('./ja-ab0ceca9.js')],
  ["ko", () => import('./ko-da8a0a68.js')],
  ["lt", () => import('./lt-ac385047.js')],
  ["lv", () => import('./lv-801bdc6f.js')],
  ["mk", () => import('./mk-c6924f32.js')],
  ["nl", () => import('./nl-b71dd00b.js')],
  ["nb", () => import('./nb-1b8c3a74.js')],
  ["pl", () => import('./pl-dd4a5879.js')],
  ["pt", () => import('./pt-32b7ef57.js')],
  ["pt-br", () => import('./pt-br-094cade6.js')],
  ["ro", () => import('./ro-05181951.js')],
  ["ru", () => import('./ru-8255e182.js')],
  ["sk", () => import('./sk-58b42580.js')],
  ["sl", () => import('./sl-51406569.js')],
  ["sr", () => import('./sr-e5da1e3e.js')],
  ["sv", () => import('./sv-587126d7.js')],
  ["th", () => import('./th-cda5e838.js')],
  ["tr", () => import('./tr-ac0f7de4.js')],
  ["uk", () => import('./uk-cd1896d0.js')],
  ["vi", () => import('./vi-3b2932a4.js')],
  ["zh-cn", () => import('./zh-cn-562b60d3.js')],
  ["zh-hk", () => import('./zh-hk-2e68f5ea.js')],
  ["zh-tw", () => import('./zh-tw-280a45f6.js')],
]);
...
const InputTimePicker = class {
  ...
  renderToggleIcon(open) {
    return (h("span", { class: CSS$1.toggleIcon }, h("calcite-icon", { icon: open ? "chevron-up" : "chevron-down", scale: "s" })));
  }
...
const TimePicker = class {
  ...
  render() {
    ...
    return (h("div", { class: {
      ...
      }, onClick: this.incrementHour, role: "button" }, h("calcite-icon", { icon: "chevron-up", scale: iconScale })), h("span", { "aria-label": this.messages.hour, "aria-valuemax": "23", "aria-valuemin": "1", "aria-valuenow": (hourIsNumber && parseInt(this.hour)) || "0", "aria-valuetext": this.hour, class: {
        [CSS.input]: true,
        [CSS.hour]: true,
      ...
      }, onClick: this.decrementHour, role: "button" }, h("calcite-icon", { icon: "chevron-down", scale: iconScale }))), h("span", { class: CSS.delimiter }, this.localizedHourSuffix), h("div", { class: CSS.column, role: "group" }, h("span", { "aria-label": this.messages.minuteUp, class: {
        [CSS.button]: true,
        [CSS.buttonMinuteUp]: true,
      }, onClick: this.incrementMinute, role: "button" }, h("calcite-icon", { icon: "chevron-up", scale: iconScale })), h("span", { "aria-label": this.messages.minute, "aria-valuemax": "12", "aria-valuemin": "1", "aria-valuenow": (minuteIsNumber && parseInt(this.minute)) || "0", "aria-valuetext": this.minute, class: {
        [CSS.input]: true,
        [CSS.minute]: true,
      ...
      }, onClick: this.decrementMinute, role: "button" }, h("calcite-icon", { icon: "chevron-down", scale: iconScale }))), this.showSecond && h("span", { class: CSS.delimiter }, this.localizedMinuteSuffix), this.showSecond && (h("div", { class: CSS.column, role: "group" }, h("span", { "aria-label": this.messages.secondUp, class: {
        [CSS.button]: true,
        [CSS.buttonSecondUp]: true,
      }, onClick: this.incrementSecond, role: "button" }, h("calcite-icon", { icon: "chevron-up", scale: iconScale })), h("span", { "aria-label": this.messages.second, "aria-valuemax": "59", "aria-valuemin": "0", "aria-valuenow": (secondIsNumber && parseInt(this.second)) || "0", "aria-valuetext": this.second, class: {
        [CSS.input]: true,
        [CSS.second]: true,
      ...
      }, onClick: this.decrementSecond, role: "button" }, h("calcite-icon", { icon: "chevron-down", scale: iconScale })))), this.showFractionalSecond && (h("span", { class: CSS.delimiter }, this.localizedDecimalSeparator)), this.showFractionalSecond && (h("div", { class: CSS.column, role: "group" }, h("span", { "aria-label": this.messages.fractionalSecondUp, class: {
        [CSS.button]: true,
        [CSS.buttonFractionalSecondUp]: true,
      }, onClick: this.incrementFractionalSecond, role: "button" }, h("calcite-icon", { icon: "chevron-up", scale: iconScale })), h("span", { "aria-label": this.messages.fractionalSecond, "aria-valuemax": "999", "aria-valuemin": "1", "aria-valuenow": (fractionalSecondIsNumber && parseInt(this.fractionalSecond)) || "0", "aria-valuetext": this.localizedFractionalSecond, class: {
        [CSS.input]: true,
      ...
      }, onClick: this.decrementFractionalSecond, role: "button" }, h("calcite-icon", { icon: "chevron-down", scale: iconScale })))), this.localizedSecondSuffix && (h("span", { class: CSS.delimiter }, this.localizedSecondSuffix)), showMeridiem && (h("div", { class: {
        [CSS.column]: true,
      ...
      }, onClick: this.incrementMeridiem, role: "button" }, h("calcite-icon", { icon: "chevron-up", scale: iconScale })), h("span", { "aria-label": this.messages.meridiem, "aria-valuemax": "2", "aria-valuemin": "1", "aria-valuenow": (this.meridiem === "PM" && "2") || "1", "aria-valuetext": this.meridiem, class: {
        [CSS.input]: true,
        [CSS.meridiem]: true,
      ...
      }, onClick: this.decrementMeridiem, role: "button" }, h("calcite-icon", { icon: "chevron-down", scale: iconScale }))))));
  }
  static get delegatesFocus() { return true; }
  static get assetsDirs() { return ["assets"]; }
  get el() { return getElement(this); }
