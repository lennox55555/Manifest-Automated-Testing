...
import { h as getSlotted, b as slotChangeHasAssignedElement, f as focusFirstTabbable, w as ensureId } from './dom-79f84f98.js';
...
import { s as setUpMessages, c as connectMessages, d as disconnectMessages, u as updateMessages } from './t9n-9a6203a1.js';
...
const Modal = class {
  ...
  renderCloseButton() {
    return !this.closeButtonDisabled ? (h("button", { "aria-label": this.messages.close, class: CSS.close, key: "button", onClick: this.closeModal, title: this.messages.close,
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
