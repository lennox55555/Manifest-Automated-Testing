...
import { h as getSlotted, g as getElementDir, t as toAriaBoolean, c as closestElementCrossShadowBoundary } from './dom-79f84f98.js';
  ...
  render() {
    ...
    return (h(Host, null, h("div", { class: {
        ...
        : this.iconType === "caret"
          ...
          : this.expanded
            ? "minus"
            : "plus", scale: this.scale === "l" ? "m" : "s" })), this.renderActionsEnd()), h("section", { "aria-labelledby": IDS.sectionToggle, class: CSS.content, id: IDS.section }, h("slot", null)))));
  }
  //--------------------------------------------------------------------------
  //
  //  Event Listeners
