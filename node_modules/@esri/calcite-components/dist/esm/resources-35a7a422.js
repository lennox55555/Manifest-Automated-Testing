 ...
 * v1.7.0
 */
import { g as getRoundRobinIndex } from './array-ff939574.js';
import { d as focusElement, h as getSlotted, t as toAriaBoolean } from './dom-79f84f98.js';
import { d as debounce } from './debounce-ec28f063.js';
import { h, H as Host } from './index-165cd388.js';
...
const List = ({ props: { disabled, loading, filterEnabled, dataForFilter, handleFilterEvent, filterPlaceholder, filterText, setFilterEl, dragEnabled, storeAssistiveEl, }, ...rest }) => {
  ...
  return (h(Host, { "aria-busy": toAriaBoolean(loading), role: "menu", ...rest },
    h("section", null,
      dragEnabled ? (h("span", { "aria-live": "assertive", class: "assistive-text", 
        // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
        ref: storeAssistiveEl })) : null,
      h("header", { class: { [CSS$1.sticky]: true } },
        filterEnabled ? (h("calcite-filter", { "aria-label": filterPlaceholder, disabled: loading || disabled, items: dataForFilter, onCalciteFilterChange: handleFilterEvent, placeholder: filterPlaceholder, value: filterText, 
          // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
...
export { CSS as C, ICON_TYPES as I, List as L, SLOTS as S, deselectSiblingItems as a, handleFilterEvent as b, getItemData as c, deselectRemovedItems as d, moveItemIndex as e, initializeObserver as f, getItemIndex as g, handleFilter as h, initialize as i, handleInitialFilter as j, keyDownHandler as k, cleanUpObserver as l, mutationObserverCallback as m, calciteListFocusOutHandler as n, calciteListItemChangeHandler as o, calciteInternalListItemValueChangeHandler as p, setUpItems as q, removeItem as r, selectSiblings as s, setFocus as t, SLOTS$2 as u, CSS$2 as v, ICONS as w };
