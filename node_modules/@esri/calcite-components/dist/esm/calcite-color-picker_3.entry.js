 ...
 * v1.7.0
 */
import { r as registerInstance, c as createEvent, h, a as getElement, F as Fragment } from './index-165cd388.js';
import { i as isPrimaryPointerButton, g as getElementDir, d as focusElement, j as getModeName } from './dom-79f84f98.js';
import { C as CSSColorMode, n as normalizeHex, a as hexify, o as opacityToAlpha, b as alphaToOpacity, c as alphaCompatible, p as parseMode, d as colorEqual, t as toNonAlphaMode, e as normalizeAlpha, f as toAlphaMode, g as normalizeColor, j as isLonghandHex, i as isValidHex, r as rgbToHex, k as hexChar } from './utils-7049def3.js';
import { c as connectInteractive, d as disconnectInteractive, u as updateHostInteraction } from './interactive-5801a6e6.js';
import { i as isActivationKey } from './key-120fe23c.js';
...
import { r as remap, c as clamp, a as closeToRangeEdge } from './math-4e0ea91f.js';
import { u as updateMessages, s as setUpMessages, c as connectMessages, d as disconnectMessages } from './t9n-9a6203a1.js';
import { t as throttle } from './throttle-d9dc6fed.js';
import './guid-3f32a87e.js';
import './resources-4b333cce.js';
import './browser-612db93f.js';
import './observers-200147a2.js';
import './debounce-ec28f063.js';
...
const ColorPicker = class {
  ...
  render() {
    ...
    return (h("div", { class: CSS$2.container }, h("div", { class: CSS$2.controlAndScope }, h("canvas", { class: CSS$2.colorField, onPointerDown: this.handleColorFieldPointerDown,
      ...
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
      ref: this.storeColorFieldScope })), h("div", { class: CSS$2.previewAndSliders }, h("calcite-color-picker-swatch", { class: CSS$2.preview, color: selectedColorInHex, scale: "l" }), h("div", { class: CSS$2.sliders }, h("div", { class: CSS$2.controlAndScope }, h("canvas", { class: { [CSS$2.slider]: true, [CSS$2.hueSlider]: true }, onPointerDown: this.handleHueSliderPointerDown,
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
      ref: this.initHueSlider }), h("div", { "aria-label": messages.hue, "aria-valuemax": HSV_LIMITS.h, "aria-valuemin": "0", "aria-valuenow": color?.round().hue() || DEFAULT_COLOR$1.round().hue(), class: { [CSS$2.scope]: true, [CSS$2.hueScope]: true }, onKeyDown: this.handleHueScopeKeyDown, role: "slider", style: {
        top: `${adjustedHueScopeTop}px`,
        left: `${adjustedHueScopeLeft}px`,
      }, tabindex: "0",
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
      ref: this.storeHueScope })), alphaChannel ? (h("div", { class: CSS$2.controlAndScope }, h("canvas", { class: { [CSS$2.slider]: true, [CSS$2.opacitySlider]: true }, onPointerDown: this.handleOpacitySliderPointerDown,
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
      ref: this.initOpacitySlider }), h("div", { "aria-label": messages.opacity, "aria-valuemax": OPACITY_LIMITS.max, "aria-valuemin": OPACITY_LIMITS.min, "aria-valuenow": (color || DEFAULT_COLOR$1).round().alpha(), class: { [CSS$2.scope]: true, [CSS$2.opacityScope]: true }, onKeyDown: this.handleOpacityScopeKeyDown, role: "slider", style: {
      ...
      ref: this.storeOpacityScope }))) : null)), noHex && noChannels ? null : (h("div", { class: {
        ...
        [CSS$2.section]: true,
      } }, h("div", { class: CSS$2.hexAndChannelsGroup }, noHex ? null : (h("div", { class: CSS$2.hexOptions }, h("calcite-color-picker-hex-input", { allowEmpty: allowEmpty, alphaChannel: alphaChannel, class: CSS$2.control, messages: messages, numberingSystem: this.numberingSystem, onCalciteColorPickerHexInputChange: this.handleHexInputChange, scale: scale, value: selectedColorInHex }))), noChannels ? null : (h("calcite-tabs", { class: {
...
const ColorPickerHexInput = class {
  ...
  render() {
    ...
    return (h("div", { class: CSS$1.container }, h("calcite-input-text", { class: CSS$1.hexInput, label: messages?.hex || hexLabel, maxLength: 6, onCalciteInputTextChange: this.onHexInputChange, onCalciteInternalInputTextBlur: this.onHexInputBlur, onKeyDown: this.onInputKeyDown, onPaste: this.onHexInputPaste, prefixText: "#", scale: inputScale, value: hexInputValue,
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
      ref: this.storeHexInputRef }), alphaChannel ? (h("calcite-input-number", { class: CSS$1.opacityInput, key: "opacity-input", label: messages?.opacity, max: OPACITY_LIMITS.max, maxLength: 3, min: OPACITY_LIMITS.min, numberButtonType: "none", numberingSystem: this.numberingSystem, onCalciteInputNumberChange: this.onOpacityInputChange, onCalciteInternalInputNumberBlur: this.onOpacityInputBlur, onKeyDown: this.onInputKeyDown, scale: inputScale, suffixText: "%", value: opacityInputValue,
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
