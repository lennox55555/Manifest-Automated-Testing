 ...
 * v1.7.0
 */
import { h, r as registerInstance, c as createEvent, H as Host, a as getElement } from './index-165cd388.js';
import { f as filter } from './filter-1ee4a630.js';
import { z as nodeListToArray, i as isPrimaryPointerButton, t as toAriaBoolean, h as getSlotted } from './dom-79f84f98.js';
import { d as defaultMenuPlacement, f as filterComputedPlacements, c as connectFloatingUI, r as reposition, a as disconnectFloatingUI, F as FloatingCSS } from './floating-ui-46044970.js';
import { s as submitForm, c as connectForm, a as afterConnectDefaultValueSet, d as disconnectForm, H as HiddenFormInputSlot } from './form-c73d3da5.js';
...
import { d as debounce } from './debounce-ec28f063.js';
import { c as connectConditionalSlotComponent, d as disconnectConditionalSlotComponent } from './conditionalSlot-d8f568e7.js';
...
function XButton({ disabled, key, label, onClick, ref, scale, }) {
  return (h("button", { "aria-label": label, class: CSS$2.button, disabled: disabled, key: key, onClick: onClick, tabIndex: -1, type: "button", 
    // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
    ref: ref },
    h("calcite-icon", { icon: "x", scale: scale === "l" ? "m" : "s" })));
}
