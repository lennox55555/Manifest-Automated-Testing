...
import { c as connectForm, d as disconnectForm, H as HiddenFormInputSlot } from './form-c73d3da5.js';
import { c as connectLabel, d as disconnectLabel, g as getLabelText } from './label-b88198aa.js';
import { b as slotChangeHasAssignedElement, t as toAriaBoolean } from './dom-79f84f98.js';
import { c as connectLocalized, d as disconnectLocalized, n as numberStringFormatter } from './locale-b09d220a.js';
import { c as createObserver } from './observers-200147a2.js';
import { s as setUpLoadableComponent, a as setComponentLoaded, c as componentFocusable, b as componentLoaded } from './loadable-d814078e.js';
...
const TextArea = class {
  ...
  render() {
    ...
    return (h(Host, null, h("textarea", { "aria-describedby": this.guid, "aria-invalid": toAriaBoolean(this.isCharacterLimitExceeded()), "aria-label": getLabelText(this), autofocus: this.autofocus, class: {
