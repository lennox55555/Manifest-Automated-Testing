...
import { l as focusElementInGroup } from './dom-79f84f98.js';
...
const TableRow = class {
    ...
    const icon = this.selectionMode === "multiple" && this.selected
      ...
      : this.selectionMode === "multiple"
        ...
        : this.selected
          ? "circle-f"
          : "circle";
    return h("calcite-icon", { icon: icon, scale: this.scale === "l" ? "m" : "s" });
  }
  ...
  render() {
    return (h(Host, null, h("tr", { "aria-disabled": this.disabled, "aria-rowindex": this.positionAll + 1, "aria-selected": this.selected, onKeyDown: (event) => this.keyDownHandler(event),
