...
import { s as submitForm, r as resetForm, f as findAssociatedForm } from './form-c73d3da5.js';
...
const Button = class {
  ...
  render() {
    ...
    return (h(Tag, { "aria-label": !this.loading ? getLabelText(this) : this.messages.loading, "aria-live": "polite", class: {
