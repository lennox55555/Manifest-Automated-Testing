...
import { b as slotChangeHasAssignedElement, s as slotChangeGetAssignedElements, f as focusFirstTabbable, t as toAriaBoolean } from './dom-79f84f98.js';
...
import { S as SLOTS$1 } from './resources-27ffbef0.js';
import { H as Heading } from './Heading-5acbb6cb.js';
import { S as SLOTS, C as CSS, I as ICONS } from './resources-e0d1e0c0.js';
...
const Panel = class {
  ...
  renderHeaderActionsEnd() {
    ...
    const closableNode = closable ? (h("calcite-action", { "aria-label": text, "data-test": "close", icon: ICONS.close, onClick: close, text: text, title: text,
  ...
  renderHeaderNode() {
    const { hasHeaderContent, hasStartActions, hasEndActions, closable, hasMenuItems, hasActionBar, } = this;
  ...
  renderContent() {
    return (h("div", { class: CSS.contentWrapper, onScroll: this.panelScrollHandler,
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
