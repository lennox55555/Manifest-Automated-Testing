 ...
 * v1.7.0
 */
import { r as registerInstance, c as createEvent, h, F as Fragment, H as Host, a as getElement } from './index-165cd388.js';
import { b as slotChangeHasAssignedElement } from './dom-79f84f98.js';
...
const CalciteNavigationLogo = class {
  ...
  render() {
    ...
    return (h(Host, null, h("a", { class: CSS$1.anchor, href: this.href, rel: this.rel, target: this.target }, thumbnail && h("img", { alt: this.label || "", class: CSS$1.image, src: thumbnail }), (heading || description) && (h("div", { class: CSS$1.container }, heading && (h("span", { "aria-label": this.heading, class: {
        [CSS$1.heading]: true,
