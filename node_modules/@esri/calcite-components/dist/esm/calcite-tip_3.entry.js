 ...
 * v1.7.0
 */
import { r as registerInstance, c as createEvent, h, F as Fragment, a as getElement } from './index-165cd388.js';
import { c as connectConditionalSlotComponent, d as disconnectConditionalSlotComponent } from './conditionalSlot-d8f568e7.js';
import { h as getSlotted, g as getElementDir, t as toAriaBoolean } from './dom-79f84f98.js';
...
const Tip = class {
  ...
  renderHeader() {
    ...
    return heading ? (h("header", { class: CSS$1.header }, h(Heading, { class: CSS$1.heading, level: level }, heading))) : null;
  }
  renderDismissButton() {
    const { closeDisabled, hideTip } = this;
    return !closeDisabled ? (h("calcite-action", { class: CSS$1.close, icon: ICONS$1.close, onClick: hideTip, scale: "l", text: this.messages.close })) : null;
  }
  renderImageFrame() {
    const { el } = this;
    return getSlotted(el, SLOTS.thumbnail) ? (h("div", { class: CSS$1.imageFrame, key: "thumbnail" }, h("slot", { name: SLOTS.thumbnail }))) : null;
  }
  renderInfoNode() {
    return (h("div", { class: CSS$1.info }, h("slot", null)));
  }
  renderContent() {
    return (h("div", { class: CSS$1.content }, this.renderImageFrame(), this.renderInfoNode()));
  }
  render() {
    return (h(Fragment, null, h("article", { class: CSS$1.container }, this.renderHeader(), this.renderContent()), this.renderDismissButton()));
  }
