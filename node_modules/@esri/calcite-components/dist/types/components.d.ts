...
export namespace Components {
  ...
  >;
    ...
    interface CalciteTableCell {
        ...
        "colSpan": number;
        /**
          * When true, prevents user interaction.  Notes:  This prop should use the @Prop decorator and reflect. The `disabled` Sass mixin must be added to the component's stylesheet.
         */
        "disabled": boolean;
        /**
          * Use this property to override individual strings used by the component.
