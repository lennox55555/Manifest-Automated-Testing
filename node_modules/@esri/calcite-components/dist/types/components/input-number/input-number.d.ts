 ...
 */
export declare class InputNumber implements LabelableComponent, FormComponent, InteractiveComponent, LocalizedComponent, T9nComponent, LoadableComponent {
  ...
  private minString?;
  private maxString?;
  private previousEmittedNumberValue;
  ...
  defaultMessages: InputNumberMessages;
   ...
   */
  calciteInputNumberInput: EventEmitter<void>;
  /**
