  ...
  static get properties() {
    return {
      ...
      "rangeLabelType": {
        ...
        "docs": {
          "tags": [],
          "text": "When either `rangeLabels` is `true`, specifies the format of displayed labels."
        },
      ...
      "unitLabel": {
        ...
        "docs": {
          "tags": [],
          "text": "When `labelType` is `\"units\"` and either `valueLabel` or `rangeLabels` are `true`, displays beside the `value` and/or  `min` values."
        },
      ...
      "valueLabelType": {
        ...
        "docs": {
          "tags": [],
          "text": "When either `valueLabel` is `true`, specifies the format of displayed label."
        },
